...
public class PoiTest {
    private static final String CUSTOMER_EXCEL = "D:/workspace/Java/ldoa/ldoa-web-boot/doc/客户列表.xls";
    ...
    public void importCustomer() {
        ...
        List<Customer> customers = ExcelImportUtil.importExcel(new File(CUSTOMER_EXCEL), Customer.class, params);

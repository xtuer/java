...
参数说明:
    ...
    no-upload-button，默认为 false，显示上传按钮, 为 false 隐藏上传按钮，可以使用 slot 按钮的文本
...
<template>
    <div class="file-uploader">
        <!-- 上传按钮，默认不显示 -->
        <Button v-if="!noUploadButton" type="primary" icon="ios-cloud-upload-outline" @click="showFileUploader"><slot>上传</slot></Button>
...
export default {
    props: {
        ...
        noUploadButton: { type: Boolean, default: false }, // 是否显示默认的上传按钮
    },
    data() {
        return {
